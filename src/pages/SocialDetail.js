      ...
      <DetailBox>
        ...
        <div className="parentBox">
          ...
          <div className="content-text">
            백엔드 직무로 지원해 합격하였는데, 입사하고 나니 갑자기 프론트엔드 일을 하라네요....
            저는 백엔드 개발자로 커리어를 쌓고 싶어요. 지금껏 프론트가 잘 맞지도 않았구요..
            신입으로 다시 취업을 준비할지(첫직장입니다), 프론트 업무와 토이프로젝트를 병행하며 백엔드로 이직을 노려볼지...
            고민이 많네요... 선배님들의 조언을 부탁드립니다ㅠㅠ
          </div>
